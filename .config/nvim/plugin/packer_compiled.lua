...
_G.packer_plugins = {
  ...
  ["lightline.vim"] = {
    loaded = true,
    path = "/home/vincent/.local/share/nvim/site/pack/packer/start/lightline.vim",
  ...
  nerdtree = {
    loaded = true,
    path = "/home/vincent/.local/share/nvim/site/pack/packer/start/nerdtree",
  ...
  ["vim-go"] = {
    loaded = true,
    path = "/home/vincent/.local/share/nvim/site/pack/packer/start/vim-go",
    url = "https://github.com/fatih/vim-go"
  },
  ["vim-smoothie"] = {
    loaded = true,
    path = "/home/vincent/.local/share/nvim/site/pack/packer/start/vim-smoothie",
